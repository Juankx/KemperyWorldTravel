        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#inicio" className="text-gray-300 hover:text-accent transition-colors duration-300">
                  Inicio
                </a>
              </li>
              <li>
                <a href="#paquetes" className="text-gray-300 hover:text-accent transition-colors duration-300">
                  Paquetes Turísticos
                </a>
              </li>
              <li>
                <a href="#testimonios" className="text-gray-300 hover:text-accent transition-colors duration-300">
                  Testimonios
                </a>
              </li>
              <li>
                <a href="#contacto" className="text-gray-300 hover:text-accent transition-colors duration-300">
                  Contacto
                </a>
              </li>
            </ul>
