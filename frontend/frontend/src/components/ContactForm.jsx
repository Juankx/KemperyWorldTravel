            ...
            <div className="animate-slide-up">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-navy">Oficina Principal</h4>
              ...
              <div className="mt-8 p-6 bg-gray-50 rounded-xl">
                <h4 className="font-semibold text-navy mb-4">¿Por qué elegirnos?</h4>
            ...
            <div className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <form onSubmit={handleSubmit} className="bg-gray-50 p-8 rounded-2xl shadow-lg">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="ciudadDestino" className="block text-sm font-medium text-gray-700 mb-2">
                      Ciudad/País de Destino *
                    </label>
                    <input
                      type="text"
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-navy focus:border-transparent ${
                        errors.ciudadDestino ? 'border-red-500' : 'border-gray-300'
                      }`}
                      placeholder="Ej: Galápagos, París, Tokio"
                    />
                    {errors.ciudadDestino && (
                      <p className="text-red-500 text-sm mt-1">{errors.ciudadDestino}</p>
                    )}
                  </div>

                  {/* Fecha de Ida */}
                  <div>
                    <label htmlFor="fechaIda" className="block text-sm font-medium text-gray-700 mb-2">
                      Fecha de Ida *
                    </label>
                    <input
                      type="date"
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-navy focus:border-transparent ${
                        errors.fechaIda ? 'border-red-500' : 'border-gray-300'
                      }`}
                    />
                    {errors.fechaIda && (
                      <p className="text-red-500 text-sm mt-1">{errors.fechaIda}</p>
                    )}
                  </div>

                  {/* Fecha de Retorno */}
                  <div>
                    <label htmlFor="fechaRetorno" className="block text-sm font-medium text-gray-700 mb-2">
                      Fecha de Retorno *
                    </label>
                    <input
                      type="date"
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-navy focus:border-transparent ${
                        errors.fechaRetorno ? 'border-red-500' : 'border-gray-300'
                      }`}
                    />
                    {errors.fechaRetorno && (
                      <p className="text-red-500 text-sm mt-1">{errors.fechaRetorno}</p>
                    )}
                  </div>
              </div>
